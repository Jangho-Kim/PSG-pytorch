...
parser.add_argument('--exp_name', default='cifar100/hyperparameter/', type=str)
...
parser.add_argument('--w_bit', default='2', type=int)
...
trainloader, valloader, testloader = utils.get_cifar100_dataloaders_disjoint(128, 100)
...
if __name__ == '__main__':
    ...
    for epoch in range(RESUME_EPOCH, FINAL_EPOCH+1):
        ...
        val_loss_LP, accuracy_LP = eval_LP(address,lambda_s,w_bits, test_flag=False)
        val_loss_FP, accuracy_FP = eval_FP(address,lambda_s,w_bits, test_flag=False)
